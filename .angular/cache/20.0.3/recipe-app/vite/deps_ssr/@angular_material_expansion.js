...
} from "./chunk-FLTJUTBC.js";
import {
  _animationsDisabled
} from "./chunk-MO76ZM2T.js";
import {
  ENTER,
  FocusKeyManager,
  FocusMonitor,
...
import "./chunk-MIS5T6EN.js";
import {
  _CdkPrivateStyleLoader
} from "./chunk-U4VUJFUD.js";
import "./chunk-ZL6SSJNC.js";
...
var MatExpansionPanel = class _MatExpansionPanel extends CdkAccordionItem {
  ...
  _inputChanges = new import_rxjs6.Subject();
...
var MatExpansionPanelHeader = class _MatExpansionPanelHeader {
  ...
  _changeDetectorRef = inject(ChangeDetectorRef);
  _parentChangeSubscription = import_rxjs6.Subscription.EMPTY;
  constructor() {
    ...
    const accordionHideToggleChange = panel.accordion ? panel.accordion._stateChanges.pipe((0, import_operators.filter)((changes) => !!(changes["hideToggle"] || changes["togglePosition"]))) : import_rxjs6.EMPTY;
    this.tabIndex = parseInt(tabIndex || "") || 0;
    this._parentChangeSubscription = (0, import_rxjs6.merge)(panel.opened, panel.closed, accordionHideToggleChange, panel._inputChanges.pipe((0, import_operators.filter)((changes) => {
